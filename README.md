...
A RSA key pair is generated by [node-rsa](https://www.npmjs.com/package/node-rsa) module.
...
```javascript
socket.rsaKeySize = 2048;  // better, but takes more time
```

#### Custom password generator

While the a handshake, a random password is generated by [randomstring](https://www.npmjs.com/package/randomstring) module.

Those passwords have a size of `48` bytes and contain alphanumeric characters, which are `UTF-8` encoded.
...
```javascript
socket.passwordGenerator = function() {
